...
const PartyNameSearch = ({ navigation }) => {
    ...
    <Layout style={{ flex: 1 }}>
      ...
      <ScrollView>
        <View style={styles.container}>
          ...
          <Layout style={styles.inputContainer} level="1">
            <Text allowFontScaling={false} style={{ fontWeight: "bold", fontSize: 15, color: "#333" }}>Petitioner/Respondent Name</Text>

            <Input
              size='large'

              // label="Petitioner/Respondent Name" 
              style={styles.input}
              placeholder="Enter party name"
              value={partyName}
              onChangeText={(nextValue) => setPartyName(nextValue)}
          ...
          <Layout style={styles.inputContainer} level="1">
            <Text allowFontScaling={false} style={{ fontWeight: "bold", fontSize: 15, color: "#333" }}>Reg. Year</Text>
