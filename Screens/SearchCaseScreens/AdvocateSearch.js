...
const AdvocateSearch = ({ navigation }) => {
    ...
    <Layout style={{ flex: 1 }}>
      ...
      <ScrollView>
        <View style={styles.container}>
          ...
          <Layout style={styles.inputContainer} level="1">
            <Text allowFontScaling={false} style={{ fontWeight: "bold", fontSize: 15, color: "#333" }}>Advocate</Text>
            ...
            <Input
              ...
              value={advocate}
              onChangeText={(nextValue) => setAdvocate(nextValue)}
