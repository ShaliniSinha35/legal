...
const ActSearch = ({ navigation }) => {
  const [courtComplexIndex, setCourtComplexIndex] = useState(new IndexPath(0));
  const [actType, setActType] = useState(new IndexPath(0));
    ...
    <Layout style={{ flex: 1 }}>
      ...
      <ScrollView>
        <View style={styles.container}>
          ...
          <Layout style={styles.inputContainer} level="1">
            <Text allowFontScaling={false} style={{ fontWeight: "bold", fontSize: 15, color: "#333" }}>Act Type</Text>
            <Select
              selectedIndex={actType}
              onSelect={(index) => setActType(index)}
            >
              <SelectItem title="Option 1" />
              <SelectItem title="Option 2" />
              <SelectItem title="Option 3" />
          ...
          <Layout style={styles.inputContainer} level="1">
            <Text allowFontScaling={false} style={{ fontWeight: "bold", fontSize: 15, color: "#333" }}>Under Section</Text>
